...
const Footer = () => {
  return (
    <footer className="flex h-72 w-full items-center justify-center bg-slate-950">
      <div className="container m-auto flex flex-col items-center justify-center border-b border-slate-400">
